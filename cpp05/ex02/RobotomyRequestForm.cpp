...
/*   Updated: 2024/02/19 14:13:43 by vcereced         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void RobotomyRequestForm::execute(Bureaucrat const &executor) const
{
	...
	srand(time(NULL));
	if (rand() % 2)
		std::cout << "XWRXWXWRXWR " << this->getTarget() << " have been robotomized!" << std::endl;
	else
		std::cout << "XWRXWXWRXWR " << this->getTarget() << " have not been robotomized! XWRXWXWRXWR" << std::endl;
}