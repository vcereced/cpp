...
/*   Updated: 2024/02/19 14:16:33 by vcereced         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(AForm &ref)
{
	...
	{
		std::cout << "Bureaucrat " << this->_name << " couldnt sign " << ref.getName() << " because " << e.what() << std::endl;
	}
} 
...
void Bureaucrat::executeForm(AForm const & form)
{
	...
	{
		std::cout << "Bureaucrat " << this->_name << " couldnt execute " << form.getName() << " because " << e.what() << std::endl;
	}
}
